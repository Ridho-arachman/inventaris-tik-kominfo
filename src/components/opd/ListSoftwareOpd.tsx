...
export default function SoftwareOpdListComponent() {
  ...
  const fetchUrl = `/software-opd${queryString ? `?${queryString}` : ""}`;
  ...
  }, [debouncedNama, jenisLisensi, kategori, status, tahun, pic]);
  ...
  const handleDelete = async (id: string) => {
    try {
      const res = await del(`/software-opd/${id}`);
      console.log(res);
  ...
  return (
    <div className="min-h-screen px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
        ...
        <Link href="/opd/asset/software/add">
                    ...
                    >
                      ...
                      <TableCell className="text-center">
                        <div className="flex flex-wrap gap-2 justify-center">
                          <Link href={`/opd/asset/software/${sw.id}`}>
                            <Button
                              variant="secondary"
                              size="sm"
                          ...
                          <Link href={`/opd/asset/software/${sw.id}/edit`}>
                            <Button
                              variant="outline"
                              size="sm"
                              className="cursor-pointer"
          ...
          <div className="space-y-4">
            <Select value={kritikalitas} onValueChange={setKritikalitas}>
              <SelectTrigger className="w-full">
                <SelectValue placeholder="Pilih Status Kritikalitas" />
              </SelectTrigger>
