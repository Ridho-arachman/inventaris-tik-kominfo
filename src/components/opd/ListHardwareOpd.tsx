...
export default function HardwareOpdListComponent() {
  ...
  }, [debouncedNama, merk, kategori, status, tahun, pic, sumber, page, limit]);

  useEffect(() => {
    const base = "/opd/asset/hardware";
  ...
  const fetchUrl = `/hardware-opd${queryString ? `?${queryString}` : ""}`;
  ...
  }, [debouncedNama, merk, kategori, status, tahun, pic, sumber]);
  ...
  const handleDelete = async (id: string) => {
    try {
      const res = await del(`/hardware-opd/${id}`);
  ...
  return (
    <div className="min-h-screen px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
        ...
        <Link href="/opd/asset/hardware/add">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-stretch sm:items-center gap-4 mb-6">
        <Input
          placeholder="Cari hardware berdasarkan nama / no seri ..."
          className="flex-1"
          value={searchNama}
                  ...
                  {hardware.map((hw) => (
                    ...
                    >
                      ...
                      <td className="p-3 flex flex-wrap gap-2 justify-center">
                        <Link href={`/opd/asset/hardware/${hw.id}`}>
                          <Button
                            variant="secondary"
                            size="sm"
                        ...
                        <Link href={`/opd/asset/hardware/${hw.id}/edit`}>
                          <Button
                            variant="outline"
                            size="sm"
                            className="cursor-pointer"
        ...
        <DialogContent>
          ...
          <div className="space-y-4">
            ...
            <Select value={tahun} onValueChange={setTahun}>
              <SelectTrigger className="w-full">
                <SelectValue placeholder="Pilih Tahun Pengadaan ..." />
              </SelectTrigger>
